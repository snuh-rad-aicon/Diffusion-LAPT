...
class DWI(Dataset):
    ...
    def __getitem__(self, index):
        ...
        data = self.transform({'dwi': dwi, 'adc': adc, 'mask': mask, 'lesion': lesion, 'dwi_minv': dwi_minv, 'dwi_maxv': dwi_maxv, 'adc_minv': adc_minv, 'adc_maxv': adc_maxv})
